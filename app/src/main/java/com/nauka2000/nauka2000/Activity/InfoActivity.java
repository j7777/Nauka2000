...
public class InfoActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(isOnline()){
            new InfoActivity.JSONParseInfo().execute();
        }
    }

    private class JSONParseInfo extends AsyncTask<String, String, JSONObject> {
        @Override
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            url = "http://nauka2000.com/?nauka_api=1&get_info=1";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_cat) {
            Intent intent = new Intent(InfoActivity.this, CatActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_tag) {
            Intent intent = new Intent(InfoActivity.this, TagActivity.class);
            startActivity(intent);
