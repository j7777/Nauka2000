...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, SwipeRefreshLayout.OnRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            } else if (getIntent().getExtras().getString("tag_slug") != null) {
                tagSlug = getIntent().getExtras().getString("tag_slug");
            }
        }
        ...
        recyclerView.addOnItemTouchListener(
                new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        Intent intent = new Intent(MainActivity.this, PostFullActivity.class);
    ...
    private class JSONParsePost extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... args) {
            ...
            try {
                if(catId != null || tagSlug != null) {
                    if (catId != null) {
                        url = "http://nauka2000.com/?nauka_api=1&get_post_cat=" + catId + "&start=" + loadStart + "&end=" + loadCount;
                    } else if (tagSlug != null) {
                        try {
                            url = "http://nauka2000.com/?nauka_api=1&get_post_tag=" + URLEncoder.encode(tagSlug, "UTF-8") + "&start=" + loadStart + "&end=" + loadCount;
                        } catch (UnsupportedEncodingException e) {
                            e.printStackTrace();
                            url = "http://nauka2000.com/?nauka_api=1&get_post_all=1&start="+loadStart+"&end="+loadCount;
                        }
                    }
                }
                else{
